    ...
    while True:
        ...
        if time_elapsed - prev >= 1.0 / frame_rate:
            ...
            if display_info:
                ...
                cv2.putText(frame, f"Offset: {percentage_offset:.2f}%", (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 1,
                            (0, 255, 0), 2)

                # Print result in console
                print(
                    f"Class: {class_name}, Confidence: {confidence_score * 100:.2f}%, Direction: {direction}, Offset: {percentage_offset:.2f}%")
            ...
            frame_queue.put(cv2.imencode('.jpg', frame))
